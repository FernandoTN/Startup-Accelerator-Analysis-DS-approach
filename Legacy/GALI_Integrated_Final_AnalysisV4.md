...
### Key Findings
- **Statistically supported effects (α = 0.05):** With n = 9,567 ventures (2,451 participants), the core OLS estimate on Δ log(revenue) remains 0.51 (≈+67%) and Δ log(FT employees) equals 0.07 (≈+7%). The FU1 debt-incidence effect is +2.3 percentage points (p = 0.02), surviving clustered standard errors and overlap diagnostics.
...
- **Program & gender dynamics:** Men-only teams post the largest revenue premium (+81%, p < 0.001) and mixed teams follow closely (+73%, p = 0.002); women-only teams still trend positive (+26%) but confidence intervals straddle zero. Investor guarantees (+6.0 pp) and sector focus (+9.7 pp) are linked to higher FU1 equity conversion, whereas demo-day intensity remains a negative but insignificant coefficient (−27%).
- **Robustness:** Propensity-score matching under a strict 0.10σ caliper retains 27.7% of treated ventures and yields a smaller but positive revenue lift (~+22%) with wide intervals; IPW adjustments nudge estimates by <1 pp, confirming that attrition does not overturn the main treatment story.
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_12_1.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_17_0.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_21_1.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_31_0.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_51_2.png)
...
```
    ...
    Time:                        11:09:19   Log-Likelihood:                -26469.
    ...
    Time:                        11:09:19   Log-Likelihood:                -11019.
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_70_0.png)
...
```
    ...
    Time:                        11:09:20   Log-Likelihood:                -26519.
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_77_2.png)
...
```
    ...
    Time:                        11:09:20   Log-Likelihood:                -26539.
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_82_2.png)
...
```
    ...
    Time:                        11:09:20   Log-Likelihood:                -25747.
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_92_2.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_97_1.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_101_1.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_102_3.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_109_2.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_123_1.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_127_1.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_137_0.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_139_1.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_143_8.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_145_0.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_150_0.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_150_4.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_152_0.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_156_0.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_164_0.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_177_0.png)
...
**Evidence-backed impacts (α = 0.05).** Accelerator participation is associated with a 0.51 log-point revenue gain (~+67%) and a +2.3 pp rise in debt usage at FU1 across the 9,567-venture analytical sample; the 0.07 log-point employment lift (~+7%) reinforces a consistent growth narrative under clustered SEs, overlap diagnostics, and IPW sensitivity checks.

**Directional signals for future validation.** Equity incidence rises by +2.1 pp (p ≈ 0.07) and small-cohort regional effects (Europe & Central Asia, Middle East & North Africa, East Asia & Pacific) straddle zero, so we treat them as hypotheses that require deeper samples rather than conclusive wins.
...
**Actionable guidance.** Accelerators should double down on investor guarantees and sector focus—features linked to higher equity conversion—while keeping demo-day emphasis in check. Policymakers can concentrate capital-readiness support in South Asia and Latin America & Caribbean, where the data show reliable, positive lifts, and invest in follow-up infrastructure for underserved regions. Entrepreneurs can treat the documented revenue and debt gains as evidence-backed while pairing them with capital-readiness programming to solidify equity outcomes.
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_185_1.png)
...
![png](GALI_Integrated_Final_AnalysisV4_files/GALI_Integrated_Final_AnalysisV4_193_1.png)
